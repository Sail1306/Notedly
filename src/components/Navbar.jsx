...
export default function Navbar() {
  ...
  return (
    <div className="w-full sticky top-0 z-50 shadow-md1">
      <nav className=" px-6 py-3 md:py-5 bg-blue-950 w-full">
            ...
            {isLoggedIn ? (
              ...
              <>
                <Link href="/login" passHref>
                  <Button
                    size="sm"
                    className="text-white bg-orange-500 hover:bg-orange-600 transition"
                  >
                    Masuk
                  </Button>
                </Link>
